...
''', default='2019')
    ...
    def configure_build_win(self):
        ...
        cmake_options = [ \
            "-DCMAKE_INSTALL_INCLUDEDIR={0}/packages/include".format(self.source_dir), \
            "-DCMAKE_INSTALL_BINDIR={0}/packages/bin".format(self.source_dir), \
            "-DCMAKE_INSTALL_LIBDIR={0}/packages/lib".format(self.source_dir), \
        ...
        if 'Visual Studio' == self.build_tool:
            ...
            self.cmake_command = ['cmake', '-G', self.cmake_gen_target] + cmake_options + [self.source_dir]
        else:
    ...
    def configure_build_lin(self):
        ...
        cmake_options = [ \
            ...
            "-DCMAKE_INSTALL_BINDIR={0}/packages/bin".format(self.source_dir), \
            "-DCMAKE_INSTALL_LIBDIR={0}/packages/lib".format(self.source_dir), \
            "-DCMAKE_BUILD_TYPE={0}".format(self.build_type)]
    ...
    def check_build_environment(self):
        ...
        self.check_tool('g++', 'g++')
        self.check_tool('c++', 'c++')
        self.logger.debug(self.full_version_check_log)
